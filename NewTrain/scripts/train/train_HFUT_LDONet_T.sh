...
# LDONet-T 教师模型训练脚本（HFUT）

usage() {
  cat <<'EOF'
用法:
  bash NewTrain/scripts/train/train_HFUT_LDONet_T.sh [选项]
...
DES_PATH="${PROJECT_ROOT}/results/HFUT/LDONet_T/checkpoint/"
PATH_RST="${PROJECT_ROOT}/results/HFUT/LDONet_T/rst_test/"
RUN_ID_NUM="400"
