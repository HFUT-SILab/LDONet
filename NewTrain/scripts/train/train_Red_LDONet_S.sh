...
usage() {
  cat <<'EOF'
用法:
  bash NewTrain/scripts/train/train_Red_LDONet_S.sh [选项]
...
DES_PATH="${PROJECT_ROOT}/results/Red/LDONet_S/checkpoint/"
PATH_RST="${PROJECT_ROOT}/results/Red/LDONet_S/rst_test/"
RUN_ID_NUM="250"
